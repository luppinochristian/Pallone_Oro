/**
 * Golden Striker — Season Planner & Match Schedule Viewer
 * Visualizes upcoming fixtures, season calendar, and performance predictions
 */
...
const GS_SeasonPlanner = (() => {
    ...
    return {
        ...
        projectSeasonStats, getDifficultyLabel, calcWinProb, getMonthName,
        SEASON_MONTHS,
    };
})();
