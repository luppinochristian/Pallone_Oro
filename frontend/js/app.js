...
const TRANSLATIONS = {
    it: {
        ...
        register_pw_placeholder:'Scegli una password',
        ...
        update_request_placeholder:'Es: Vorrei che si potesse scegliere la formazione, oppure aggiungere modalità torneo...',
    ...
    en: {
        ...
        register_pw_placeholder:'Choose a password',
        register_pw2_placeholder:'Repeat password',
        ...
        update_request_placeholder:'E.g. I would like to be able to choose the formation, or add a tournament mode...',
...
async function _retranslateNewsInView() {
    if (currentPlayer) loadDashboardNotizie();
}
