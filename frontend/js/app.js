...
async function loadTransfer() {
    ...
    // Controlla finestra mercato
    const mese = parseInt(p.mese_corrente) || parseInt(currentPlayer?.mese_corrente) || 9;
    const anno = parseInt(p.anno_corrente) || parseInt(currentPlayer?.anno_corrente) || 1;
