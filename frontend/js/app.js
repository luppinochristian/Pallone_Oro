...
const CC_ALL_NATIONS = [
    {key:'Italy',       key_it:'Italia',         flag:'🇮🇹', color:'#009246'},
    {key:'Brazil',      key_it:'Brasile',         flag:'🇧🇷', color:'#009c3b'},
    {key:'Argentina',   key_it:'Argentina',       flag:'🇦🇷', color:'#74acdf'},
    {key:'France',      key_it:'Francia',         flag:'🇫🇷', color:'#002395'},
    {key:'Spain',       key_it:'Spagna',          flag:'🇪🇸', color:'#c60b1e'},
    {key:'Germany',     key_it:'Germania',        flag:'🇩🇪', color:'#000'},
    {key:'Portugal',    key_it:'Portogallo',      flag:'🇵🇹', color:'#006600'},
    {key:'England',     key_it:'Inghilterra',     flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', color:'#cf142b'},
    {key:'Netherlands', key_it:'Olanda',          flag:'🇳🇱', color:'#ae1c28'},
    {key:'Japan',       key_it:'Giappone',        flag:'🇯🇵', color:'#bc002d'},
    {key:'USA',         key_it:'USA',             flag:'🇺🇸', color:'#3c3b6e'},
    {key:'Nigeria',     key_it:'Nigeria',         flag:'🇳🇬', color:'#008751'},
    {key:'Belgium',     key_it:'Belgio',          flag:'🇧🇪', color:'#ef3340'},
    {key:'Croatia',     key_it:'Croazia',         flag:'🇭🇷', color:'#e31837'},
    {key:'Uruguay',     key_it:'Uruguay',         flag:'🇺🇾', color:'#5aaaa8'},
    {key:'Colombia',    key_it:'Colombia',        flag:'🇨🇴', color:'#fcd116'},
    {key:'Mexico',      key_it:'Messico',         flag:'🇲🇽', color:'#006847'},
    {key:'SouthKorea',  key_it:'Corea del Sud',   flag:'🇰🇷', color:'#cd2e3a'},
    {key:'Senegal',     key_it:'Senegal',         flag:'🇸🇳', color:'#00853f'},
    {key:'Morocco',     key_it:'Marocco',         flag:'🇲🇦', color:'#c1272d'},
    {key:'Ghana',       key_it:'Ghana',           flag:'🇬🇭', color:'#006b3f'},
    {key:'Sweden',      key_it:'Svezia',          flag:'🇸🇪', color:'#006aa7'},
    {key:'Denmark',     key_it:'Danimarca',       flag:'🇩🇰', color:'#c60c30'},
    {key:'Austria',     key_it:'Austria',         flag:'🇦🇹', color:'#ed2939'},
    {key:'Switzerland', key_it:'Svizzera',        flag:'🇨🇭', color:'#ff0000'},
    {key:'Poland',      key_it:'Polonia',         flag:'🇵🇱', color:'#dc143c'},
    {key:'Ukraine',     key_it:'Ucraina',         flag:'🇺🇦', color:'#005bbb'},
    {key:'Turkey',      key_it:'Turchia',         flag:'🇹🇷', color:'#e30a17'},
    {key:'Serbia',      key_it:'Serbia',          flag:'🇷🇸', color:'#c6363c'},
    {key:'Scotland',    key_it:'Scozia',          flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿', color:'#003078'},
    {key:'CzechRepublic',key_it:'Rep. Ceca',      flag:'🇨🇿', color:'#d7141a'},
    {key:'Romania',     key_it:'Romania',         flag:'🇷🇴', color:'#002b7f'},
    {key:'SaudiArabia', key_it:'Arabia Saudita',  flag:'🇸🇦', color:'#006c35'},
    {key:'Ivory_Coast', key_it:"Costa d'Avorio",  flag:'🇨🇮', color:'#f77f00'},
    {key:'Algeria',     key_it:'Algeria',         flag:'🇩🇿', color:'#006233'},
    {key:'Australia',   key_it:'Australia',       flag:'🇦🇺', color:'#00008b'},
    {key:'Canada',      key_it:'Canada',          flag:'🇨🇦', color:'#ff0000'},
    {key:'Chile',       key_it:'Cile',            flag:'🇨🇱', color:'#d52b1e'},
    {key:'Ecuador',     key_it:'Ecuador',         flag:'🇪🇨', color:'#ffd100'},
];
...
function ccBuildNationList(filter = '') {
    ...
    list.innerHTML = filtered.map(n => `
        <div class="cc-nation-item ${n.key === current ? 'active' : ''}"
             style="border-left: 3px solid ${n.color || 'var(--border)'};"
...
function ccBuildSummary() {
    ...
    document.getElementById('cc-summary-tags').innerHTML = [
        `<span class="cc-tag" style="border-left:3px solid ${nation?.color||'var(--border)'};">${currentLang==='en'?natKey.replace(/_/g,' '):(nation?.key_it||natKey)}</span>`,
