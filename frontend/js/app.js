...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (langWrapInit) langWrapInit.style.display = 'none';
...
function showPage(page) {
    ...
    if (page === 'auth') {
        ...
        const lw = document.getElementById('lang-switcher-wrap');
    ...
    if (langWrap) langWrap.style.display = isInGame ? 'flex' : 'none';
