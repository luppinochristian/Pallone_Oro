...
function _renderBracket(bracket, player) {
    ...
    // Cerca il vincitore del playoff: prima tra chi è già agli ottavi (pos 2 o 3),
    // poi come pending tra chi è ancora in playoff/playoff_3
    const playoffWinner = (g2, g3) =>
        ...
        byGruppo(allPlayoff2, g2) || byGruppo(allPlayoff3, g3) || null;
    ...
    const ottaviPairs = [
        [ottaviByGruppo['A'], playoffWinner('B','D'), '1°A vs Playoff'],
        [ottaviByGruppo['B'], playoffWinner('A','C'), '1°B vs Playoff'],
        [ottaviByGruppo['C'], playoffWinner('D','B'), '1°C vs Playoff'],
        [ottaviByGruppo['D'], playoffWinner('C','A'), '1°D vs Playoff'],
    ].filter(([a,b]) => a || b);
    if (ottaviPairs.length)
        cols.push({ title: '🔵 Ottavi', matches: ottaviPairs.map(([a,b,l]) => matchBox(a,b,l)) });
