...
function showResults(res) {
    ...
    if (legaMsgs.length) {
        ...
        legaMsgs.forEach(m => {
            ...
            html += `<div class="res-match-card" style="border-top:3px solid ${color}" data-gol="${m.player_gol ?? 0}">
    ...
    list.innerHTML = html;
    _animateResultsModal(modal, res, legaMsgs);
}

function _animateResultsModal(modal, res, legaMsgs) {
...
document.getElementById('close-results').addEventListener('click', () => {
    ...
    // Reset animazioni per la prossima apertura
