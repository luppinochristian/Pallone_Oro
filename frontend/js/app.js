...
function showPage(page) {
    ...
    if (page === 'dashboard') { renderDashboard(); setTimeout(fixNewsBoxHeight, 100); }
...
document.addEventListener('DOMContentLoaded', () => setTimeout(fixNewsBoxHeight, 100));
