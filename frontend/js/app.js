...
async function toggleCareerYear(anno) {
    ...
    const fmtLog = (log, tipo) => {
        ...
        if (tipo.includes('Gol'))    return `<div class="career-detail-card"><div class="career-detail-label">⚽ ${tipo}</div><div class="career-detail-val">${log.gol} gol</div><div class="career-detail-sub">${mese} · ${log.assist} assist · voto ${log.voto}</div></div>`;
        if (tipo.includes('Assist')) return `<div class="career-detail-card"><div class="career-detail-label">🎯 ${tipo}</div><div class="career-detail-val">${log.assist} assist</div><div class="career-detail-sub">${mese} · ${log.gol} gol · voto ${log.voto}</div></div>`;
        return `<div class="career-detail-card"><div class="career-detail-label">⭐ ${tipo}</div><div class="career-detail-val">Voto ${log.voto}</div><div class="career-detail-sub">${mese} · ${log.gol} gol · ${log.assist} assist</div></div>`;
    };
