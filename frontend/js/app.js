        ...
        gruppiKeys.forEach(g => {
            ...
            teams.forEach((t, i) => {
                ...
                html += `<tr class="${qualClass} ${isMe ? 'champ-g-me' : ''}">
                    ...
                    <td>${t.vittorie_gruppo ?? 0}</td>
                    <td>${t.pareggi_gruppo ?? 0}</td>
                    <td>${t.sconfitte_gruppo ?? 0}</td>
                    <td>${t.gol_fatti_gruppo ?? 0}</td>
                    <td>${t.gol_subiti_gruppo ?? 0}</td>
        ...
        fasiLabel.forEach(f => {
            ...
            teams.forEach(t => {
                ...
                html += `<div class="champions-team ${isMe ? 'my-champions-team' : ''} ${t.eliminato ? 'elim' : ''}">
                    <span>${flag ? flag + ' ' : ''}${t.team_nome}</span>
