...
const TRANSLATIONS = {
    ...
    de: {
        ...
        ag_owned:'✅ Aktiv',
        obj_header:'🎯 Saisonziele', obj_completed:'abgeschlossen',
    ...
    es: {
        ...
        ag_owned:'✅ Activo',
        obj_header:'🎯 Objetivos de Temporada', obj_completed:'completados',
        obj_morale_prize:'moral',
...
function renderLogTable(data, container) {
    ...
    if (data.length > paginated.length) {
        html += `<button onclick="loadMoreLog()" style="width:100%;padding:10px;margin-top:8px;background:var(--bg3);border:1px solid var(--border);border-radius:8px;color:var(--text-dim);cursor:pointer;font-size:0.82rem">
            ${{it:'Carica altri...',en:'Load more...',de:'Mehr laden...',es:'Cargar más...'}[currentLang]||'Carica altri...'} (${data.length - paginated.length} ${currentLang === 'en' ? 'remaining' : 'rimanenti'})
        </button>`;
    }
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (flagElInit) flagElInit.textContent = _flagMap[currentLang] || '🇮🇹';
