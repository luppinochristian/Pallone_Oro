...
function showResults(res) {
    ...
    if (legaMsgs.length) {
        ...
        legaMsgs.forEach((m, i) => {
            ...
            const isPlayerMatch = i === 0; // prima partita = quella del giocatore col voto
            const golLabel = isPlayerMatch ? (match.gol ?? 0) : '-';
            const assistLabel = isPlayerMatch ? (match.assist ?? 0) : '-';
            html += `<div class="res-match-card" style="border-top:3px solid ${color}">
                ...
                ${isPlayerMatch ? `<div class="res-match-stats">
                    <span>⚽ ${golLabel} gol</span>
                    <span>🎯 ${assistLabel} assist</span>
