 ...
 * Refactored: verde campo come accento primario, performance-safe,
 * nessun interval su proprietà paint, rAF con stop condition.
 */
...
const GS_Animations = (() => {
    ...
    function glowPulse(el) {
        if (!el) return;
        // Remove any existing listener to prevent duplicates on rapid calls
        const oldClone = el.cloneNode(false);
