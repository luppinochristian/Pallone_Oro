/**
 * Golden Striker — Football Encyclopedia
 * Historical data, statistics records, tactical knowledge
 */
...
const GS_Encyclopedia = (() => {
    ...
    function getFormationInfo(formation, lang = 'it') {
        ...
        return {
            formation,
            era: info.era,
            description: lang === 'en' ? info.desc_en : info.desc_it,
        };
    }
    ...
    return {
        WORLD_CUP_RECORDS, FORMATIONS_HISTORY, POSITIONS, FAMOUS_QUOTES,
        PALLONE_ORO_HISTORY, TRAINING_TIPS, TRANSFER_GLOSSARY,
        getRandomQuote, getRandomTrainingTip, getFormationInfo,
        getPositionGuide, getTransferGlossaryTerm,
