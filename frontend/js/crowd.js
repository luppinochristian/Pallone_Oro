/**
 * ============================================================
 * crowd.js — Sistema tifosi e atmosfera da stadio
 * ============================================================
 * Simula le animazioni del pubblico sugli spalti tramite canvas,
 * con variazioni di intensità in base agli eventi di gioco.
 *
 * FUNZIONALITÀ:
 *  - Rendering canvas degli spalti con sediolini colorati
 *  - Animazione dei tifosi (alzarsi, sedersi, ondeggiare)
 *  - Intensità variabile: calma → eccitata → esultanza
 *  - Overlay testuali per cori e canti (via classe CSS)
 *  - Colori distinti per tifosi di casa, ospiti, neutrali
 *
 * PALETTE:
 *  - Casa: blu (#1e3a8a → #60a5fa)
 *  - Ospiti: rosso (#7f1d1d → #f87171)
 *  - Neutrali: grigi (#374151 → #9ca3af)
 *  - Evento: verde (#00C566) e oro (#E8B84B)
 *
 * API pubblica:
 *  - init(canvas): inizializza con l'elemento canvas
 *  - setIntensity(level): imposta intensità 0-1
 *  - triggerEvent(type): evento speciale (gol, fischio finale...)
 *
 * Esposto come oggetto globale GS_Crowd.
 * ============================================================
 */
