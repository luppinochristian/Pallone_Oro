/**
 * Golden Striker — Extended Localization & Game Content Data
 * Complete strings, flavor texts, historical references, and game lore
 */
...
const GS_Locale = (() => {
    ...
    return {
        STRINGS, MILESTONES, NATIONALITIES, PALLONE_ORO_SPEECHES,
        RETIREMENT_SPEECHES, TRANSFER_ANNOUNCEMENTS, LEAGUE_DESCRIPTIONS,
        RATING_DESCRIPTIONS, POP_LEVELS, SKILL_LORE,
        getMilestone, getPopLevel, getRatingDesc, getLeagueDesc,
        getNationality, getPalloneSpeech, getRetirementSpeech,
        getSkillLore, getTransferAnnouncement,
        injectMilestoneBadge, injectPopLabel,
    };
})();
