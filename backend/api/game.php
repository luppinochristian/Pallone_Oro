...
function getExtraNewsPool($nome, $team, $avv, $pgol, $passist, $pvoto, $esito, $overall, $pop, $stelle, $anno, $mese) {
    ...
    switch ($mese) {
        ...
        case 12:
            ...
            $pgol_bilancio = $pgol > 5 ? "Soddisfatto dei gol" : "Devo fare di più nel girone di ritorno";
            $pool[] = ["🏁 Bilancio di metà stagione", "A dicembre {$nome} fa i conti: '{$pgol_bilancio}'. Il mister è d'accordo.", "info"];
            break;
        case 1:
...
function _tn(string $it, string $en): string { return getLang() === 'en' ? $en : $it; }
function _tna(array $it, array $en): array   { return getLang() === 'en' ? $en : $it; }
