...
function simulaGiornataGruppo($db, $p, $record, $anno, $mese) {
    ...
    // NPC round-robin — coppie uniche per mese, senza ripetere avversari già giocati dal giocatore
    // Partite NPC: sett=[avv2 vs avv3], ott=[avv0 vs avv3], nov=[avv0 vs avv3], dic=[avv1 vs avv2]
    $npc_schedule = [
        9  => [[2,3]],
        10 => [[0,3]],
        11 => [[0,3]],
