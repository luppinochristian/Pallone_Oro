...
function playMonth($player_id, $data) {
    ...
    $nuovo_infortunio_mesi = 0; // separato da $infortuni_mesi (DB value) per evitare collisione
        ...
        switch ($azione) {
            ...
            case 'allenamento_speciale':
                ...
                if ($rischio > 75) {
                    ...
                    $nuovo_infortunio_mesi = $durata_infortunio; // verrà salvato sotto
    ...
    if ($nuovo_infortunio_mesi > 0) {
        // Nuovo infortunio avvenuto questo mese → sovrascrive (es. ricaduta)
        $new_infortuni = $nuovo_infortunio_mesi;
    } elseif ($prev_infortuni > 0) {
        // Nessun nuovo infortunio → decrementa guarigione
