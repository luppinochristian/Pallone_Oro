...
function playMonth($player_id, $data) {
    ...
    // --- FINE STAGIONE (giugno → luglio) ---
    // La stagione va da settembre (9) a giugno (6): dopo giugno si avanza anno
    if ($new_mese > 6 && $p['mese_corrente'] == 6) {
        $new_mese = 7; // luglio, inizio mercato estivo
        $new_anno++; $new_age++;
