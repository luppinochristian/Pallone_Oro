...
function getNotizie($player_id) {
    ...
    // Return the correct language version: use titolo_en/testo_en if lang=en and available,
    // otherwise fall back to titolo/testo (always Italian)
    $lang = getLang();
    $notizie = array_map(function($n) use ($lang) {
        ...
        // Remove raw bilingual columns from response to keep payload lean
