...
function initSchema($pdo) {
    $pdo->exec("CREATE TABLE IF NOT EXISTS players (
        ...
        mese_corrente INTEGER DEFAULT 9, anno_corrente INTEGER DEFAULT 1,
    ...
    try { $pdo->exec("ALTER TABLE players ADD COLUMN account_id INTEGER NOT NULL DEFAULT 0"); } catch(Exception $e) {}
    try { $pdo->exec("ALTER TABLE players ADD COLUMN career_name TEXT NOT NULL DEFAULT 'Carriera'"); } catch(Exception $e) {}
    try { $pdo->exec("ALTER TABLE players ADD COLUMN skin_hair TEXT DEFAULT 'short_black'"); } catch(Exception $e) {}
    try { $pdo->exec("ALTER TABLE players ADD COLUMN skin_color TEXT DEFAULT 'medium'"); } catch(Exception $e) {}
    try { $pdo->exec("ALTER TABLE players ADD COLUMN eye_color TEXT DEFAULT 'brown'"); } catch(Exception $e) {}
    ...
    try { $pdo->exec("ALTER TABLE players ADD COLUMN hair_color TEXT DEFAULT '#1a1a1a'"); } catch(Exception $e) {}
    try { $pdo->exec("ALTER TABLE players ADD COLUMN ai_avatar TEXT DEFAULT NULL"); } catch(Exception $e) {}
    try { $pdo->exec("ALTER TABLE players ADD COLUMN ai_prompt TEXT DEFAULT NULL"); } catch(Exception $e) {}
