...
(2,'Spogliatoio Attrezzato',110000,1,1,2,'+1 crescita stats, -2% rischio infortuni'),
(3,'Palestra e Campo',200000,2,2,5,'+2 crescita stats, -5% rischio infortuni'),
(4,'Centro Sportivo',380000,2,10,8,'+10% crescita, -8% rischio infortuni'),
(5,'Centro High-Tech',600000,3,20,10,'+20% crescita, -10% infortuni'),
(6,'Centro d''Elite',950000,4,28,15,'Staff medico dedicato, +28% crescita, -15% infortuni'),
(7,'Academy Personale',1500000,5,35,20,'Staff completo, crescita +35%, -20% infortuni');
